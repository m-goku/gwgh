    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="grid max-w-screen-xl   mx-auto lg:gap-8 xl:gap-0  lg:grid-cols-12">
        ...
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="max-w-3xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-4xl xl:text-5xl dark:text-white">
            Grow Crops. Feed Communities. Change the World.
          </h1>
          <p className="max-w-3xl mb-6 font-light text-lg text-gray-500 lg:mb-8 md:text-xl lg:text-xl dark:text-gray-400">
