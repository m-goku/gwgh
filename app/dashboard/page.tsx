    ...
    <div>
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                <svg
                  className="w-5 h-5 text-gray-500 transition duration-75 dark:text-green-400 group-hover:text-green-900 dark:group-hover:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 22 21"
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Zones</span>
              </a>
            </li>
      ...
      <div className="p-4 sm:ml-64">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl mt-5">
          ...
          {/* Card 3 */}
          <Card label="Total Value" value="250,000" />
          <Card label="Total Farmers" value="6723" />
        </div>
      </div>
    </div>
  );
